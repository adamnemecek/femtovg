...
fn main() {
    ...
    pollster::block_on(demo::run(event_loop, window));
}
            ...
            *control_flow = ControlFlow::Poll;
            ...
            match event {
                ...
                Event::RedrawRequested(_) => {
                    ...
                    // canvas.set_size(size.width as u32, size.height as u32, dpi_factor as f32); // Don't do this or you risk panicking when resizing the window.
