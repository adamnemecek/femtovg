...
fn main() {
    ...
    pollster::block_on(simple::run(event_loop, window));
...
mod simple {
        ...
        let (device, queue) = adapter
            .request_device(
                &wgpu::DeviceDescriptor {
                    ...
                    limits: wgpu::Limits {
                        max_push_constant_size: 8, // This must be at-least 8
                        ..wgpu::Limits::default()
                    },
                    label: None,
                },
            ...
            match event {
                ...
                Event::WindowEvent { ref event, .. } => match event {
                    ...
                    WindowEvent::Resized(physical_size) => {
                        ...
                        canvas.set_size(physical_size.width as _, physical_size.height as _, dpi_factor as f32);
                    }
                ...
                Event::RedrawRequested(_) => {
                    ...
                    // draw_text(&mut canvas, &fonts, "fdaasdfadsfasfsa", 50.0, 200.0, 100.0, 100.0);
    ...
    //     for i in 0..100 {
    //         for j in 0..100 {
    //             fill_rect(canvas, (2 *  i) as _ , (2 * j) as _, 1.0, 1.0);
    //         }
    //     }
    // }
    ...
    fn draw_simple_graph<T: Renderer>(canvas: &mut Canvas<T>, x: f32, y: f32, w: f32, h: f32, t: f32) {
        let dx = w / 5.0;
        let mut sx = [0.0; 6];
        let mut sy = [0.0; 6];
